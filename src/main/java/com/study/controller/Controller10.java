...
public class Controller10 {
    ...
    public void method1(Model model) {
        ...
        // 결과를 모델에 담고
        // view 로 포워딩 (/WEB-INF/view/main10/sub1.jsp)
    ...
    public void method7(Model model) {
        ...
        e1.setModelName("포르쉐");
        e2.setModelName("페라리");
        e3.setModelName("람보르기니");
        e1.setPrice(300_000_000);
        e2.setPrice(250_000_000);
        e3.setPrice(500_000_000);
        e1.setColor("blue");
        e2.setColor("red");
        e3.setColor("black");
    ...
    public void method9(Model model) {
        ...
        e1.setCity("부산");
        e1.setFoods(List.of("밀면", "돼지국밥", "몰라"));
        e2.setCity("평양");
        e2.setFoods(List.of("냉면", "돼지감자", "몰라"));
