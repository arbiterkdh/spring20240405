...
public class Controller20 {
    ...
    @RequestMapping("sub6")
    public void sub6(String type, String address, Model model) {
    ...
    public void sub7(String name,
                     ...
                     String hobby,
                     Model model) {
        model.addAttribute("result", name + "님의 나이는 " + age + " 입니다.");
...
//        왜냐, 안쓰면 그것으로 간주하기로 api 에 써있기 때문
...
//        MyBean202 객체의 property 로 바인딩 되도록 코드 작성
